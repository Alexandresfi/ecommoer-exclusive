...
export function InfoAbout() {
  return (
    <ul className="flex justify-center items-center gap-[30px] flex-wrap lg:justify-start">
      <li className="pb-[20px] px-[35px] max-w-[270px] h-[230px] flex flex-col justify-center items-center gap-4 border rounded hover:bg-orange-secondary hover:text-white-default transition-colors">
