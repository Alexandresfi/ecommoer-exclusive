...
export function Footer() {
  return (
    <footer className="mt-20 pt-20 pb-6 text-white-primary bg-black">
      <div>
        <div className="flex justify-center items-baseline flex-col md:flex-row gap-10 flex-wrap px-5 md:justify-start xl:px-0 md:max-w-container lg:gap-0 lg:justify-between m-auto">
          <div>
